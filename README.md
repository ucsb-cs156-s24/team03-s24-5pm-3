...
|-----------------------------|--------------|---------------|
| `UCSBDiningCommonsMenuItem` | Aaron        | Xalex217      |
| `UCSBOrganization`          | Tyler        | yuxiaolejs    |
| `RecommendationRequest`     | Tyler        | tmcanepa      |
| `MenuItemReview`            | Tyler        | sherpatran    |
| `HelpRequest`               | Andrew       | andrew-kwon1  |
| `Articles`                  | Aaron        | 30912hyl      |
