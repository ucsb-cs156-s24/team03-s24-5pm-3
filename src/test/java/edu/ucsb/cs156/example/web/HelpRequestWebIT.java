...
public class HelpRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_helprequest() throws Exception {
        ...
        page.getByTestId("HelpRequestForm-teamId").fill("s24-5pm-3");
        page.getByTestId("HelpRequestForm-tableOrBreakoutRoom").fill("11");
        ...
        page.getByTestId("HelpRequestForm-explanation").fill("Dokku help");
        page.getByTestId("HelpRequestForm-submit").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-explanation")).hasText("Dokku help");
