...
public class ArticleWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_article() throws Exception {
        ...
        page.getByTestId("ArticlesForm-url").fill("easyaviancom");
        page.getByTestId("ArticlesForm-explanation").fill("Build your own burrito chain");
        page.getByTestId("ArticlesForm-email").fill("Freebirdsgmailcom");
        page.getByTestId("ArticlesForm-dateAdded").fill("2022-01-02T12:00");
