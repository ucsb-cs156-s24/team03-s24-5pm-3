...
public class UCSBDCMIWebIT extends WebTestCase {
    @Test
    public void admin_user_can_create_edit_delete_ucsbdiningcommons() throws Exception {
        setupUser(true);
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-name").fill("Pizza");
        page.getByTestId("UCSBDiningCommonsMenuItemForm-station").fill("station 1");
