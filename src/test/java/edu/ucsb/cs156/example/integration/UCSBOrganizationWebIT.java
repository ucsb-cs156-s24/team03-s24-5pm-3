...
public class UCSBOrganizationWebIT {
        @Autowired
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                UCSBOrganizations org1 = UCSBOrganizations.builder()
                                ...
                                .orgTranslationShort("Org 1")
                                .inactive(false)
                                .build();

                ucsbOrganizationsRepository.save(org1);
        ...
        public void an_admin_user_can_post_a_new_restaurant() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/UCSBOrganization/post?orgCode=ORG1&orgTranslation=Organization 1&orgTranslationShort=Org 1&inactive=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
